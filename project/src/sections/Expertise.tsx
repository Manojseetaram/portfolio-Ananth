...
import { Gamepad, Stethoscope, Building2, Clapperboard, Car, Microscope, ShoppingBag, Tv2 } from "lucide-react"
...
const expertiseFields: ExpertiseField[] = [
  ...
  },
  {
    ...
    icon: Stethoscope,
    description: "Accurate 3D visualization for medical and educational purposes",
    skills: ["Anatomical Models", "Surgical Animations", "Medical Device Renders"],
  },
  {
  ...
  },
  {
    ...
    icon: Car,
    description: "Detailed automotive modeling and visualization",
    skills: ["Vehicle Modeling", "Product Renders", "Technical Animation"],
  },
  {
    title: "Scientific Visualization",
    icon: Microscope,
    description: "Complex scientific concepts brought to life in 3D",
    skills: ["Molecular Visualization", "Data Visualization", "Educational Content"],
  },
  {
  ...
  },
  {
    ...
    icon: Tv2,
    description: "Real-time virtual production and LED wall content",
    skills: ["Real-time Environments", "Virtual Sets", "LED Integration"],
  },
]
